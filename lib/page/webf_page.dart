...
class WebFApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: 'assets:///demos/gallery/build/kraken/index.js',
      // initialRoute: 'https://www.ucharts.cn/v2/#/demo/index',
      // home: const Scaffold(body: Center(child: Text("hello, Flutter."))),
      onGenerateRoute: (RouteSettings settings) {
        String name =
            settings.name ?? "assets:///demos/gallery/build/kraken/index.js";
